...
CREATE TABLE BORROWER.BORROWER_ADDRESS
	(
...
ALTER TABLE [BORROWER].[BORROWER_ADDRESS]
ADD CONSTRAINT PK_BORROWER_ADDRESS_ADDERSSID PRIMARY KEY (ADDRESSID);
...
-----SPLIT---[NAME OF TEAM MEMBER RESPONSIBLE]------
